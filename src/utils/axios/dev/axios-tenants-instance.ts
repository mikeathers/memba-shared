...
import {DEV_API_ROUTES, JWT_LOCALSTORAGE_KEY} from '@/config'
import {getItemFromLocalStorage} from '../../storage'

export const axiosTenantsAuthInstanceDev = axios.create({
  baseURL: DEV_API_ROUTES.TENANTS_API,
  headers: {
...
axiosTenantsAuthInstanceDev.interceptors.request.use(
